...
작은 성공은 실패 없이도 이룰 수 있지만, **큰 성공은 실패 없이 오지 않습니다**. 실패하지 않는 것보다 중요한 것은 **실패로부터 배우는 것**입니다. **끈기와 긍정, 무한한 배움의 자세**로 임하는 주니어 개발자가 되겠습니다.
...
| 기간 | 활동 |
| --- | --- |
| 2025.09 ~ 현재 | 창업팀 **직직직** 백엔드 개발자 · PM |
| 2026.03 ~ 현재 | **멋쟁이사자처럼 DAU 14기** 백엔드 팀 |
